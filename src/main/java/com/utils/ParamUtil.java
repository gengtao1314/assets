...
public class ParamUtil<T> {
     ...
     * @return void
     */
    public void check(T t,List<String> params) throws Exception {
        ...
        if (t != null) {
            ...
            for (String param : params) {
                ...
                if (type == null) {
                    throw new Exception("设置的必填字段" + param + "不存在");
                } else if (type.endsWith("String")) {
                    if (val == null || val == "") {
                        throw new Exception("必填String字段出错");
                    }
                } else if (type.endsWith("Integer") || type.endsWith("int")) {
                    if (val == null || val == "") {
                        throw new Exception("必填Integer字段出错");
                    }
                } else if (type.endsWith("BigDecimal")) {
                    if (val == null || val == "") {
                        throw new Exception("必填BigDecimal字段出错");
                    }
                } else if (type.endsWith("boolean") || type.endsWith("Boolean")) {
                    if (val == null || val == "") {
                        throw new Exception("必填Boolean字段出错");
                    }
                } else if (type.endsWith("Date")) {
                    if (val == null || val == "") {
                        throw new Exception("必填Date字段出错");
                    }
