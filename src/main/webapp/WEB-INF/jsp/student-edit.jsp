...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" autocomplete="off" placeholder="" id="major" name="major">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>入学时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" onfocus="WdatePicker()" id="myAdmissionTime" name="myAdmissionTime" class="input-text Wdate" style="width:120px;">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>出生日期：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" onfocus="WdatePicker()" id="myBirthday" name="myBirthday" class="input-text Wdate" style="width:120px;">
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    ...
    $("#myAdmissionTime").val(date(parent.admissionTime));
    $("#myBirthday").val(date(parent.birthday));
    $("#major").val(parent.major);
