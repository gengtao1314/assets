...
<%@ taglib prefix="fyoit" uri="http://fyoit.com/com/" %>
<%
                        ...
                        <select class="form-control" id="customerFrom" name="source">
                            ...
                            <c:forEach items="${fromType}" var="item">
                                <option value="${item.id}"
                                        <c:if test="${item.id == source}">selected</c:if>>
                                        ${item.item_name }
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="industry" name="industry">
                            ...
                            <c:forEach items="${industryType}" var="item">
                                <option value="${item.id}"
                                        <c:if test="${item.id == industry}"> selected</c:if>>
                                        ${item.item_name }
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="level" name="level">
                            ...
                            <c:forEach items="${levelType}" var="item">
                                <option value="${item.id}"
                                        <c:if test="${item.id == level}"> selected</c:if>>
                                        ${item.item_name }
                                </option>
                            </c:forEach>
                        </select>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="col-md-12 text-right">
                        <fyoit:page url="${pageContext.request.contextPath }/customer/list"/>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="new_customer_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="new_customerFrom" name="source">
                                <option value="">--请选择--</option>
                                <c:forEach items="${fromType}" var="item">
                                    <option value="${item.id}" <c:if test="${item.id == source}">selected</c:if>>
                                            ${item.item_name }
                                    </option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="form-group">
                        <label for="new_industry" style="float:left;padding:7px 15px 0 27px;">所属行业</label>
                        <div class="col-sm-10">
                            <select class="form-control" id="new_industry" name="industry">
                                <option value="">--请选择--</option>
                                <c:forEach items="${industryType}" var="item">
                                    <option value="${item.id}"<c:if test="${item.id == industry}"> selected</c:if>>
                                            ${item.item_name }
                                    </option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="form-group">
                        <label for="new_level" style="float:left;padding:7px 15px 0 27px;">客户级别</label>
                        <div class="col-sm-10">
                            <select class="form-control" id="new_level" name="level">
                                <option value="">--请选择--</option>
                                <c:forEach items="${levelType}" var="item">
                                    <option value="${item.id}"<c:if
                                            test="${item.id == level}"> selected</c:if>>${item.item_name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="edit_customerFrom" name="source">
                                ...
                                <c:forEach items="${fromType}" var="item">
                                    <option value="${item.id}"<c:if
                                            test="${item.id == source}"> selected</c:if>>${item.item_name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="edit_industry" style="float:left;padding:7px 15px 0 27px;">所属行业</label>
                        <div class="col-sm-10">
                            <select class="form-control" id="edit_industry" name="industry">
                                <option value="">--请选择--</option>
                                <c:forEach items="${industryType}" var="item">
                                    <option value="${item.id}"<c:if
                                            test="${item.id == industry}"> selected</c:if>>${item.item_name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="edit_level" style="float:left;padding:7px 15px 0 27px;">客户级别</label>
                        <div class="col-sm-10">
