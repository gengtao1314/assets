...
<div>
    ...
    <form id="form-search" class="page-container">
        <div class="text-c">
            <input type="text" name="username" id="username" placeholder=" 姓名" style="width:250px" class="input-text">
            <button name="" id="searchButton" type="submit" class="btn btn-success"><i class="Hui-iconfont">&#xe665;</i> 搜索</button>
        </div>
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius" onclick="toadd('添加','user-add','',600)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加</a></span> <span class="r">共有数据：<strong id="num">0</strong> 条</span> </div>
        <div class="mt-20">
...
<script type="text/javascript">
        ...
        $('.table').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    "data": null,
                    render : function(data,type, row, meta) {
                        return "<a id=\"td-manage\" style=\"text-decoration:none\" onClick=\"todelete(this,"+row.id+")\" href=\"javascript:;\" title=\"删除\"><i class=\"Hui-iconfont\">&#xe631;</i></a> <a title=\"编辑\" href=\"javascript:;\" onclick=\"toedit('编辑','user-edit',"+row.id+",'',500)\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i>";
                    }
                }
            ],
    ...
    $("#form-search").validate({
        ...
        submitHandler:function(form){
            ...
            table.ajax.url( '${pageContext.request.contextPath}/user/search' ).load();
        }
    });
    ...
    var username="",id=-1,password="",createtime="";
    ...
    function toedit(title,url,uid,w,h){
        ...
        $('.table tbody').on( 'click', 'tr', function () {
            ...
            createtime = table.row(this).data().createtime;
        });
        layer_show(title,url,w,h);
    }
